...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VisualAcuityCorrection.beo'
        db.add_column('anonymeyes_visualacuitycorrection', 'beo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VisualAcuityCorrection.beo'
        db.delete_column('anonymeyes_visualacuitycorrection', 'beo')
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('b2d2050d-d1e6-42a5-bff8-21c547bbb171')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
