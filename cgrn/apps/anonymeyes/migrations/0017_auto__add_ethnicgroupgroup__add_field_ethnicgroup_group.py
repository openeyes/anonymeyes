...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EthnicGroupGroup'
        db.create_table('anonymeyes_ethnicgroupgroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('sort', self.gf('django.db.models.fields.IntegerField')(default=10)),
        ))
        db.send_create_signal('anonymeyes', ['EthnicGroupGroup'])

        # Adding field 'EthnicGroup.group'
        db.add_column('anonymeyes_ethnicgroup', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['anonymeyes.EthnicGroupGroup']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'EthnicGroupGroup'
        db.delete_table('anonymeyes_ethnicgroupgroup')

        # Deleting field 'EthnicGroup.group'
        db.delete_column('anonymeyes_ethnicgroup', 'group_id')
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('bd071522-675a-46d0-ac7e-bfec53cf72c2')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
