...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VisualAcuityMethod.scale'
        db.add_column('anonymeyes_visualacuitymethod', 'scale',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['anonymeyes.VisualAcuityScale']),
                      keep_default=False)
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('8fdf3782-0672-49f4-a9b5-09387c3ed63a')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
            'visual_acuity_both': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
        ...
        'anonymeyes.visualacuityreading': {
            'Meta': {'ordering': "['sort', 'name']", 'object_name': 'VisualAcuityReading'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'scale': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['anonymeyes.VisualAcuityScale']"}),
            'sort': ('django.db.models.fields.IntegerField', [], {'default': '10'}),
