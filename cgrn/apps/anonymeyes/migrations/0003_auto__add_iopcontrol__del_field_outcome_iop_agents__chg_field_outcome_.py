...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Outcome.iop_control' to match new field type.
        db.rename_column('anonymeyes_outcome', 'iop_control', 'iop_control_id')
        # Changing field 'Outcome.iop_control'
        db.alter_column('anonymeyes_outcome', 'iop_control_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['anonymeyes.IOPControl']))
        # Adding index on 'Outcome', fields ['iop_control']
        db.create_index('anonymeyes_outcome', ['iop_control_id'])


    def backwards(self, orm):
        # Removing index on 'Outcome', fields ['iop_control']
        ...
        # Renaming column for 'Outcome.iop_control' to match new field type.
        db.rename_column('anonymeyes_outcome', 'iop_control_id', 'iop_control')
        # Changing field 'Outcome.iop_control'
        db.alter_column('anonymeyes_outcome', 'iop_control', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('8eeb730c-116d-4ab2-9dac-29332381c5a3')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
