...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Eye.single'
        db.add_column('anonymeyes_eye', 'single',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Eye.sort'
        db.add_column('anonymeyes_eye', 'sort',
                      self.gf('django.db.models.fields.IntegerField')(default=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Eye.single'
        db.delete_column('anonymeyes_eye', 'single')

        # Deleting field 'Eye.sort'
        db.delete_column('anonymeyes_eye', 'sort')
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('d2d47820-865d-4373-97a6-11950c58649a')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
