...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VisualAcuityMethod.scale'
        db.delete_column('anonymeyes_visualacuitymethod', 'scale_id')

        # Adding M2M table for field scales on 'VisualAcuityMethod'
        db.create_table('anonymeyes_visualacuitymethod_scales', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('visualacuitymethod', models.ForeignKey(orm['anonymeyes.visualacuitymethod'], null=False)),
            ('visualacuityscale', models.ForeignKey(orm['anonymeyes.visualacuityscale'], null=False))
        ))
        db.create_unique('anonymeyes_visualacuitymethod_scales', ['visualacuitymethod_id', 'visualacuityscale_id'])


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'VisualAcuityMethod.scale'
        raise RuntimeError("Cannot reverse this migration. 'VisualAcuityMethod.scale' and its values cannot be restored.")
        # Removing M2M table for field scales on 'VisualAcuityMethod'
        db.delete_table('anonymeyes_visualacuitymethod_scales')
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('b2c338cc-f931-447d-a490-2f7d7004186b')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
