...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Patient.lens_extraction_date_left'
        db.alter_column('anonymeyes_patient', 'lens_extraction_date_left', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Patient.lens_extraction_date_right'
        db.alter_column('anonymeyes_patient', 'lens_extraction_date_right', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Patient.lens_extraction_date_left'
        raise RuntimeError("Cannot reverse this migration. 'Patient.lens_extraction_date_left' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Patient.lens_extraction_date_right'
        raise RuntimeError("Cannot reverse this migration. 'Patient.lens_extraction_date_right' and its values cannot be restored.")
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('29e992b6-d6f1-4fce-96b4-b846c4df4960')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
            'visual_acuity_both': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
