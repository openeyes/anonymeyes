...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Patient.visual_acuity_method_comment'
        db.add_column('anonymeyes_patient', 'visual_acuity_method_comment',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Outcome.visual_acuity_method_comment'
        db.add_column('anonymeyes_outcome', 'visual_acuity_method_comment',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Patient.visual_acuity_method_comment'
        db.delete_column('anonymeyes_patient', 'visual_acuity_method_comment')

        # Deleting field 'Outcome.visual_acuity_method_comment'
        db.delete_column('anonymeyes_outcome', 'visual_acuity_method_comment')
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('b1758be7-f762-42c0-bedc-4a634e1f641e')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
