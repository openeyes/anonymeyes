...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Patient.health_care'
        db.add_column('anonymeyes_patient', 'health_care',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['anonymeyes.HealthCare']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Patient.health_care'
        db.delete_column('anonymeyes_patient', 'health_care_id')
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('d31b56da-d855-4795-9630-242dce2ffb8c')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
