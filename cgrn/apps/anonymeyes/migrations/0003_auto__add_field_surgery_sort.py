...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Surgery.sort'
        db.add_column('anonymeyes_surgery', 'sort',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Surgery.sort'
        db.delete_column('anonymeyes_surgery', 'sort')
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('4a9f0cd3-c0a8-4ace-b1b8-b5843ef37453')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
            'visual_acuity_both': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
