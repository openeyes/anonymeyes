...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Patient.anaesthesia'
        db.delete_column('anonymeyes_patient', 'anaesthesia_id')


        # Renaming column for 'Patient.eua' to match new field type.
        db.rename_column('anonymeyes_patient', 'eua', 'eua_id')
        # Changing field 'Patient.eua'
        db.alter_column('anonymeyes_patient', 'eua_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['anonymeyes.Anaesthesia']))
        # Adding index on 'Patient', fields ['eua']
        db.create_index('anonymeyes_patient', ['eua_id'])


    def backwards(self, orm):
        # Removing index on 'Patient', fields ['eua']
        db.delete_index('anonymeyes_patient', ['eua_id'])

        # Adding field 'Patient.anaesthesia'
        db.add_column('anonymeyes_patient', 'anaesthesia',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['anonymeyes.Anaesthesia'], null=True, blank=True),
                      keep_default=False)


        # Renaming column for 'Patient.eua' to match new field type.
        db.rename_column('anonymeyes_patient', 'eua_id', 'eua')
        # Changing field 'Patient.eua'
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('859463cb-5478-486d-9c47-809b9524f2c9')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
