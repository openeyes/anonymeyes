...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('anonymeyes_patient', 'iop_agents_right',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='patient_iop_agents_right', to=orm['anonymeyes.IOPAgents']),
                      keep_default=False)

        # Adding field 'Patient.iop_agents_left'
        db.add_column('anonymeyes_patient', 'iop_agents_left',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='patient_iop_agents_left', to=orm['anonymeyes.IOPAgents']),
                      keep_default=False)
        ...
        db.add_column('anonymeyes_outcome', 'iop_agents_right',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='outcome_iop_agents_right', to=orm['anonymeyes.IOPAgents']),
                      keep_default=False)

        # Adding field 'Outcome.iop_agents_left'
        db.add_column('anonymeyes_outcome', 'iop_agents_left',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='outcome_iop_agents_left', to=orm['anonymeyes.IOPAgents']),
                      keep_default=False)
