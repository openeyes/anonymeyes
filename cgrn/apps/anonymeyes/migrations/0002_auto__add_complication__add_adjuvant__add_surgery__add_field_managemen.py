...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Management.surgery'
        db.add_column('anonymeyes_management', 'surgery',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['anonymeyes.Surgery'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Management.complication'
        db.add_column('anonymeyes_management', 'complication',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['anonymeyes.Complication'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Management.adjuvant'
        db.add_column('anonymeyes_management', 'adjuvant',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['anonymeyes.Adjuvant'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Management.surgery'
        db.delete_column('anonymeyes_management', 'surgery_id')

        # Deleting field 'Management.complication'
        db.delete_column('anonymeyes_management', 'complication_id')

        # Deleting field 'Management.adjuvant'
        db.delete_column('anonymeyes_management', 'adjuvant_id')
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('6314d169-2e18-4be1-8a51-5184494647ae')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
            'visual_acuity_both': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
