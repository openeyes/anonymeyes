...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Diagnosis.group'
        db.add_column('anonymeyes_diagnosis', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['anonymeyes.DiagnosisGroup']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Diagnosis.group'
        db.delete_column('anonymeyes_diagnosis', 'group_id')
    ...
    models = {
        ...
        'anonymeyes.diagnosisgroup': {
            'Meta': {'object_name': 'DiagnosisGroup'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('72c5e0a7-7209-4a01-a372-7ea5defb9575')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
            'visual_acuity_both': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
