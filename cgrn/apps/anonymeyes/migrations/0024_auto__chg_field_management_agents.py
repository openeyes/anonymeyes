...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Management.agents' to match new field type.
        db.rename_column('anonymeyes_management', 'agents', 'agents_id')
        # Changing field 'Management.agents'
        db.alter_column('anonymeyes_management', 'agents_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['anonymeyes.IOPAgents'], null=True))
        # Adding index on 'Management', fields ['agents']
        db.create_index('anonymeyes_management', ['agents_id'])


    def backwards(self, orm):
        # Removing index on 'Management', fields ['agents']
        db.delete_index('anonymeyes_management', ['agents_id'])


        # Renaming column for 'Management.agents' to match new field type.
        db.rename_column('anonymeyes_management', 'agents_id', 'agents')
        # Changing field 'Management.agents'
        db.alter_column('anonymeyes_management', 'agents', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('10a55e1d-a516-46c6-99f7-d7ca44e7b793')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
