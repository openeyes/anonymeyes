...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PostcodeValidator'
        db.create_table('anonymeyes_postcodevalidator', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pattern', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('error', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('anonymeyes', ['PostcodeValidator'])


        # Changing field 'Patient.postcode'
        db.alter_column('anonymeyes_patient', 'postcode', self.gf('django.db.models.fields.CharField')(max_length=5))
        # Adding field 'Country.postcode_validator'
        db.add_column('anonymeyes_country', 'postcode_validator',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['anonymeyes.PostcodeValidator']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'PostcodeValidator'
        db.delete_table('anonymeyes_postcodevalidator')


        # Changing field 'Patient.postcode'
        db.alter_column('anonymeyes_patient', 'postcode', self.gf('django.db.models.fields.CharField')(max_length=4))
        # Deleting field 'Country.postcode_validator'
        db.delete_column('anonymeyes_country', 'postcode_validator_id')
    ...
    models = {
        ...
        'anonymeyes.country': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'postcode_validator': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['anonymeyes.PostcodeValidator']"}),
            'sort': ('django.db.models.fields.IntegerField', [], {'default': '10'})
        },
        ...
        'anonymeyes.iopagent': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'no_agents': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'sort': ('django.db.models.fields.IntegerField', [], {'default': '10'})
        },
        ...
        'anonymeyes.management': {
            ...
            'agents': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['anonymeyes.IOPAgent']", 'symmetrical': 'False', 'blank': 'True'}),
        ...
        'anonymeyes.outcome': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'iop_agents_left': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'outcome_iop_agents_left'", 'symmetrical': 'False', 'to': "orm['anonymeyes.IOPAgent']"}),
            'iop_agents_right': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'outcome_iop_agents_right'", 'symmetrical': 'False', 'to': "orm['anonymeyes.IOPAgent']"}),
            'iop_control_left': ('django.db.models.fields.IntegerField', [], {}),
            'iop_control_right': ('django.db.models.fields.IntegerField', [], {}),
        ...
        'anonymeyes.patient': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'iop_agents_left': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'patient_iop_agents_left'", 'symmetrical': 'False', 'to': "orm['anonymeyes.IOPAgent']"}),
            'iop_agents_right': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'patient_iop_agents_right'", 'symmetrical': 'False', 'to': "orm['anonymeyes.IOPAgent']"}),
            'iop_left': ('django.db.models.fields.IntegerField', [], {}),
            'iop_right': ('django.db.models.fields.IntegerField', [], {}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('a7065ac4-0231-46ab-8566-bc5a8df35a42')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
        ...
        'anonymeyes.postcodevalidator': {
            'Meta': {'object_name': 'PostcodeValidator'},
            'error': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pattern': ('django.db.models.fields.CharField', [], {'max_length': '64'})
        },
        'anonymeyes.surgery': {
        ...
        'anonymeyes.userprofile': {
            ...
            'dob_min_precision': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'related_name': "'+'", 'to': "orm['anonymeyes.DOBPrecision']"}),
            'dob_precision': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'related_name': "'+'", 'to': "orm['anonymeyes.DOBPrecision']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
