...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Patient.visual_acuity_both' to match new field type.
        db.rename_column('anonymeyes_patient', 'visual_acuity_both', 'visual_acuity_both_id')
        # Changing field 'Patient.visual_acuity_both'
        db.alter_column('anonymeyes_patient', 'visual_acuity_both_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['anonymeyes.VisualAcuityReading']))
        # Adding index on 'Patient', fields ['visual_acuity_both']
        db.create_index('anonymeyes_patient', ['visual_acuity_both_id'])


        # Renaming column for 'Patient.visual_acuity_right' to match new field type.
        db.rename_column('anonymeyes_patient', 'visual_acuity_right', 'visual_acuity_right_id')
        # Changing field 'Patient.visual_acuity_right'
        db.alter_column('anonymeyes_patient', 'visual_acuity_right_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['anonymeyes.VisualAcuityReading']))
        # Adding index on 'Patient', fields ['visual_acuity_right']
        db.create_index('anonymeyes_patient', ['visual_acuity_right_id'])


        # Renaming column for 'Patient.visual_acuity_left' to match new field type.
        db.rename_column('anonymeyes_patient', 'visual_acuity_left', 'visual_acuity_left_id')
        # Changing field 'Patient.visual_acuity_left'
        db.alter_column('anonymeyes_patient', 'visual_acuity_left_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['anonymeyes.VisualAcuityReading']))
        # Adding index on 'Patient', fields ['visual_acuity_left']
        db.create_index('anonymeyes_patient', ['visual_acuity_left_id'])


    def backwards(self, orm):
        # Removing index on 'Patient', fields ['visual_acuity_left']
        db.delete_index('anonymeyes_patient', ['visual_acuity_left_id'])

        # Removing index on 'Patient', fields ['visual_acuity_right']
        db.delete_index('anonymeyes_patient', ['visual_acuity_right_id'])

        # Removing index on 'Patient', fields ['visual_acuity_both']
        db.delete_index('anonymeyes_patient', ['visual_acuity_both_id'])


        # Renaming column for 'Patient.visual_acuity_both' to match new field type.
        db.rename_column('anonymeyes_patient', 'visual_acuity_both_id', 'visual_acuity_both')
        # Changing field 'Patient.visual_acuity_both'
        db.alter_column('anonymeyes_patient', 'visual_acuity_both', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Renaming column for 'Patient.visual_acuity_right' to match new field type.
        db.rename_column('anonymeyes_patient', 'visual_acuity_right_id', 'visual_acuity_right')
        # Changing field 'Patient.visual_acuity_right'
        db.alter_column('anonymeyes_patient', 'visual_acuity_right', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Renaming column for 'Patient.visual_acuity_left' to match new field type.
        db.rename_column('anonymeyes_patient', 'visual_acuity_left_id', 'visual_acuity_left')
        # Changing field 'Patient.visual_acuity_left'
        db.alter_column('anonymeyes_patient', 'visual_acuity_left', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('fdca0688-b168-4572-bc4a-53ae6c66ac8b')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
