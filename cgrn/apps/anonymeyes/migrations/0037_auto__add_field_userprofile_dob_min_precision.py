...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.dob_min_precision'
        db.add_column('anonymeyes_userprofile', 'dob_min_precision',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='+', to=orm['anonymeyes.DOBPrecision']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.dob_min_precision'
        db.delete_column('anonymeyes_userprofile', 'dob_min_precision_id')
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('dfc360e8-aea8-478b-9b58-719c3a26de9b')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
