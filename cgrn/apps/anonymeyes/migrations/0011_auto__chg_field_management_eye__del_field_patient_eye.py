...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Management.eye'
        db.alter_column('anonymeyes_management', 'eye_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['anonymeyes.Eye'], null=True))
        # Deleting field 'Patient.eye'
        db.delete_column('anonymeyes_patient', 'eye_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Management.eye'
        raise RuntimeError("Cannot reverse this migration. 'Management.eye' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Patient.eye'
        raise RuntimeError("Cannot reverse this migration. 'Patient.eye' and its values cannot be restored.")
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('e93c1593-434d-4e6d-8a07-8ef59be66d56')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
            'visual_acuity_both': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
