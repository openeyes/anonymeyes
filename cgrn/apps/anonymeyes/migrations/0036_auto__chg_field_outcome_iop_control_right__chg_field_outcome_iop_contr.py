...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Outcome.iop_control_right'
        db.alter_column('anonymeyes_outcome', 'iop_control_right', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Outcome.iop_control_left'
        db.alter_column('anonymeyes_outcome', 'iop_control_left', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Outcome.iop_control_right'
        db.alter_column('anonymeyes_outcome', 'iop_control_right', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Outcome.iop_control_left'
        db.alter_column('anonymeyes_outcome', 'iop_control_left', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('dded4ee9-39b9-48f5-a6c1-21f8bb736431')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
