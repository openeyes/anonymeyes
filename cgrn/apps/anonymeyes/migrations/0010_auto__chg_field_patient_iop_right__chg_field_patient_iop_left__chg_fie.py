...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Patient.iop_right'
        db.alter_column('anonymeyes_patient', 'iop_right', self.gf('django.db.models.fields.IntegerField')(default=1))

        # Changing field 'Patient.iop_left'
        db.alter_column('anonymeyes_patient', 'iop_left', self.gf('django.db.models.fields.IntegerField')(default=1))

        # Changing field 'Outcome.iop_left'
        db.alter_column('anonymeyes_outcome', 'iop_left', self.gf('django.db.models.fields.IntegerField')(default=1))

        # Changing field 'Outcome.iop_right'
        db.alter_column('anonymeyes_outcome', 'iop_right', self.gf('django.db.models.fields.IntegerField')(default=1))

    def backwards(self, orm):

        # Changing field 'Patient.iop_right'
        db.alter_column('anonymeyes_patient', 'iop_right', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Patient.iop_left'
        db.alter_column('anonymeyes_patient', 'iop_left', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Outcome.iop_left'
        db.alter_column('anonymeyes_outcome', 'iop_left', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Outcome.iop_right'
        db.alter_column('anonymeyes_outcome', 'iop_right', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('0ce2cdd1-932b-4653-a228-1cf961fffcc8')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
