...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VisualAcuityReading.value'
        db.delete_column('anonymeyes_visualacuityreading', 'value')


    def backwards(self, orm):
        # Adding field 'VisualAcuityReading.value'
        db.add_column('anonymeyes_visualacuityreading', 'value',
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('552843d4-7c50-4d2e-b5ca-a41aeec3eb8b')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
