...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Adjuvant.sort'
        db.add_column('anonymeyes_adjuvant', 'sort',
                      self.gf('django.db.models.fields.IntegerField')(default=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Adjuvant.sort'
        db.delete_column('anonymeyes_adjuvant', 'sort')
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('3bfa64d2-df25-4b82-8227-b00e0186eab8')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
            'visual_acuity_both': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
