...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('anonymeyes_userprofile', (
            ...
            ('dob_precision', self.gf('django.db.models.fields.IntegerField')(default=3)),
        ))
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('b3502752-3220-4082-b20f-eacda9d7bc4e')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
        ...
        'anonymeyes.userprofile': {
            ...
            'dob_precision': ('django.db.models.fields.IntegerField', [], {'default': '3'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
