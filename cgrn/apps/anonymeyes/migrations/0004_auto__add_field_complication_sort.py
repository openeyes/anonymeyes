...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Complication.sort'
        db.add_column('anonymeyes_complication', 'sort',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Complication.sort'
        db.delete_column('anonymeyes_complication', 'sort')
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('25441a34-df4a-456a-a7d5-8de3faae841d')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
            'visual_acuity_both': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
