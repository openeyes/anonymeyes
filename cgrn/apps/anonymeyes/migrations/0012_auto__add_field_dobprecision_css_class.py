...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DOBPrecision.css_class'
        db.add_column('anonymeyes_dobprecision', 'css_class',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DOBPrecision.css_class'
        db.delete_column('anonymeyes_dobprecision', 'css_class')
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('9ef1b0bf-e985-4312-87f9-8a714401deae')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
