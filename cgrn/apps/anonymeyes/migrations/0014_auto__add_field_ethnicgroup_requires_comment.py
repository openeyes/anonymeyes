...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EthnicGroup.requires_comment'
        db.add_column('anonymeyes_ethnicgroup', 'requires_comment',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EthnicGroup.requires_comment'
        db.delete_column('anonymeyes_ethnicgroup', 'requires_comment')
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('1e4dc7c1-6e15-4260-8136-1ace3d4fd4a1')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
