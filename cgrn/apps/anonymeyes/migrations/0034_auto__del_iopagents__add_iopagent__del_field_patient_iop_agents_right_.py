...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('anonymeyes', ['IOPAgent'])
        ...
        db.create_table('anonymeyes_patient_iop_agents_right', (
            ...
            ('patient', models.ForeignKey(orm['anonymeyes.patient'], null=False)),
            ('iopagent', models.ForeignKey(orm['anonymeyes.iopagent'], null=False))
        ))
        ...
        db.create_table('anonymeyes_outcome_iop_agents_right', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('outcome', models.ForeignKey(orm['anonymeyes.outcome'], null=False)),
            ('iopagent', models.ForeignKey(orm['anonymeyes.iopagent'], null=False))
        ))
        ...
        db.create_table('anonymeyes_management_agents', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('management', models.ForeignKey(orm['anonymeyes.management'], null=False)),
            ('iopagent', models.ForeignKey(orm['anonymeyes.iopagent'], null=False))
        ))
    ...
    def backwards(self, orm):
        ...
        db.send_create_signal('anonymeyes', ['IOPAgents'])
        ...
        db.add_column('anonymeyes_management', 'agents',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['anonymeyes.IOPAgents'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'anonymeyes.management': {
            ...
            'agents': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['anonymeyes.IOPAgent']", 'symmetrical': 'False'}),
