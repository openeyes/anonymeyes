...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Patient.health_care'
        db.alter_column('anonymeyes_patient', 'health_care_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['anonymeyes.HealthCare']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Patient.health_care'
        db.alter_column('anonymeyes_patient', 'health_care_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['anonymeyes.Anaesthesia']))
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('048b2743-7632-45ce-8f23-3d0959e12c88')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
