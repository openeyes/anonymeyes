...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'health_care': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['anonymeyes.Anaesthesia']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('83259f8f-784c-46ff-a7f9-00eb4873deca')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
