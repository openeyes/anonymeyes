...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Patient.comments'
        db.add_column('anonymeyes_patient', 'comments',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Patient.comments'
        db.delete_column('anonymeyes_patient', 'comments')
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('f7cd11fd-3352-4dc4-8060-315ac2c7eb74')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
