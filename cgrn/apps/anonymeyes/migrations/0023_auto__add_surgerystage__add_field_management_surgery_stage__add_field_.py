...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Management.surgery_stage'
        db.add_column('anonymeyes_management', 'surgery_stage',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['anonymeyes.SurgeryStage'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Surgery.stage'
        db.add_column('anonymeyes_surgery', 'stage',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Management.surgery_stage'
        db.delete_column('anonymeyes_management', 'surgery_stage_id')

        # Deleting field 'Surgery.stage'
        db.delete_column('anonymeyes_surgery', 'stage')
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('58b73c96-53cc-4ab0-91e6-d2c972ddc71a')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
