...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Patient.outcome_overdue'
        db.add_column('anonymeyes_patient', 'outcome_overdue',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Patient.outcome_overdue'
        db.delete_column('anonymeyes_patient', 'outcome_overdue')
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'next_reminder': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('0f204182-a767-460c-bc74-d1fac2dac16d')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
