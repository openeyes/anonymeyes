...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Patient.next_reminder'
        db.add_column('anonymeyes_patient', 'next_reminder',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Patient.next_reminder'
        db.delete_column('anonymeyes_patient', 'next_reminder')
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('dc759185-f4cb-48b2-ac4a-023790307e88')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
