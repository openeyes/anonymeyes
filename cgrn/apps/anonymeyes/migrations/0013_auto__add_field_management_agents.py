...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('anonymeyes_management', 'agents')
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('f9e4a3a5-f60e-46c2-aa4b-a67dc8c88fc2')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
