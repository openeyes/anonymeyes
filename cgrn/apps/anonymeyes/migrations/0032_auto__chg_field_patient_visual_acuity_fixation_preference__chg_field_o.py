...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Patient.visual_acuity_fixation_preference'
        db.alter_column('anonymeyes_patient', 'visual_acuity_fixation_preference', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Outcome.visual_acuity_fixation_preference'
        db.alter_column('anonymeyes_outcome', 'visual_acuity_fixation_preference', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Patient.visual_acuity_fixation_preference'
        raise RuntimeError("Cannot reverse this migration. 'Patient.visual_acuity_fixation_preference' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Outcome.visual_acuity_fixation_preference'
        raise RuntimeError("Cannot reverse this migration. 'Outcome.visual_acuity_fixation_preference' and its values cannot be restored.")
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('8d2a3794-9383-49f5-8a2c-88d3e9d5bbfc')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
