...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Complication.requires_comment'
        db.add_column('anonymeyes_complication', 'requires_comment',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Surgery.requires_comment'
        db.add_column('anonymeyes_surgery', 'requires_comment',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Complication.requires_comment'
        db.delete_column('anonymeyes_complication', 'requires_comment')

        # Deleting field 'Surgery.requires_comment'
        db.delete_column('anonymeyes_surgery', 'requires_comment')
