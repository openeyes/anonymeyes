...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Diagnosis.requires_comment'
        db.add_column('anonymeyes_diagnosis', 'requires_comment',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Diagnosis.requires_comment'
        db.delete_column('anonymeyes_diagnosis', 'requires_comment')
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('7ae0d386-e8d8-4d01-8b93-a3d0ed115055')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
