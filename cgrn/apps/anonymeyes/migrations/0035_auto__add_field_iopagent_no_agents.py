...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IOPAgent.no_agents'
        db.add_column('anonymeyes_iopagent', 'no_agents',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IOPAgent.no_agents'
        db.delete_column('anonymeyes_iopagent', 'no_agents')
    ...
    models = {
        ...
        'anonymeyes.management': {
            ...
            'agents': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['anonymeyes.IOPAgent']", 'null': 'True', 'blank': 'True'}),
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('3db8f65b-a959-4404-9bc2-37259e1aeb0b')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
