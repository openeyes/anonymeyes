...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('anonymeyes_country', (
        ...
        db.send_create_signal('anonymeyes', ['Country'])

        # Adding field 'Patient.country'
        db.add_column('anonymeyes_patient', 'country',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['anonymeyes.Country']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Country'
        db.delete_table('anonymeyes_country')

        # Deleting field 'Patient.country'
        db.delete_column('anonymeyes_patient', 'country_id')
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('5aa3594c-c4e8-4945-8687-627694162aeb')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
