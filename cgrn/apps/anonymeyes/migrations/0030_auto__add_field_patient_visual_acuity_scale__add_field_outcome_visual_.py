...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Patient.visual_acuity_scale'
        db.add_column('anonymeyes_patient', 'visual_acuity_scale',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='patient_visualacuity_scale', to=orm['anonymeyes.VisualAcuityScale']),
                      keep_default=False)

        # Adding field 'Outcome.visual_acuity_scale'
        db.add_column('anonymeyes_outcome', 'visual_acuity_scale',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='outcome_visualacuity_scale', to=orm['anonymeyes.VisualAcuityScale']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Patient.visual_acuity_scale'
        db.delete_column('anonymeyes_patient', 'visual_acuity_scale_id')

        # Deleting field 'Outcome.visual_acuity_scale'
        db.delete_column('anonymeyes_outcome', 'visual_acuity_scale_id')
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('3442f06e-0227-4265-b2e2-ac0a606b2dd6')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
