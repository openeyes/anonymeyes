...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ManagementType.sort'
        db.add_column('anonymeyes_managementtype', 'sort',
                      self.gf('django.db.models.fields.IntegerField')(default=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ManagementType.sort'
        db.delete_column('anonymeyes_managementtype', 'sort')
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('69b39ceb-be07-442b-8a98-464b7a96372b')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
