...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Patient.ethnic_group_comments'
        db.delete_column('anonymeyes_patient', 'ethnic_group_comments')

        # Deleting field 'Patient.comments'
        db.delete_column('anonymeyes_patient', 'comments')

        # Adding field 'Patient.ethnic_group_comment'
        db.add_column('anonymeyes_patient', 'ethnic_group_comment',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Patient.diagnosis_right_comment'
        db.add_column('anonymeyes_patient', 'diagnosis_right_comment',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Patient.diagnosis_left_comment'
        db.add_column('anonymeyes_patient', 'diagnosis_left_comment',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Patient.ethnic_group_comments'
        db.add_column('anonymeyes_patient', 'ethnic_group_comments',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)
        ...
        # Deleting field 'Patient.ethnic_group_comment'
        db.delete_column('anonymeyes_patient', 'ethnic_group_comment')

        # Deleting field 'Patient.diagnosis_right_comment'
        db.delete_column('anonymeyes_patient', 'diagnosis_right_comment')

        # Deleting field 'Patient.diagnosis_left_comment'
        db.delete_column('anonymeyes_patient', 'diagnosis_left_comment')
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('40d163c6-b80b-4b88-8fbb-180f5d1860a1')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
