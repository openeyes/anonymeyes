...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LensStatusGroup'
        db.create_table('anonymeyes_lensstatusgroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('sort', self.gf('django.db.models.fields.IntegerField')(default=10)),
        ))
        db.send_create_signal('anonymeyes', ['LensStatusGroup'])

        # Adding field 'LensStatus.sort'
        db.add_column('anonymeyes_lensstatus', 'sort',
                      self.gf('django.db.models.fields.IntegerField')(default=10),
                      keep_default=False)

        # Adding field 'LensStatus.group'
        db.add_column('anonymeyes_lensstatus', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['anonymeyes.LensStatusGroup']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'LensStatusGroup'
        db.delete_table('anonymeyes_lensstatusgroup')

        # Deleting field 'LensStatus.sort'
        db.delete_column('anonymeyes_lensstatus', 'sort')

        # Deleting field 'LensStatus.group'
        db.delete_column('anonymeyes_lensstatus', 'group_id')
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('8d01f5e7-d0a3-439d-95fe-f1ff590551ce')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
