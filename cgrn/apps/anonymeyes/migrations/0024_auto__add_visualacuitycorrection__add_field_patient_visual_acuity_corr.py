...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Patient.visual_acuity_correction_right'
        db.add_column('anonymeyes_patient', 'visual_acuity_correction_right',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='patient_rva_correction', to=orm['anonymeyes.VisualAcuityCorrection']),
                      keep_default=False)

        # Adding field 'Patient.visual_acuity_correction_left'
        db.add_column('anonymeyes_patient', 'visual_acuity_correction_left',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='patient_lva_correction', to=orm['anonymeyes.VisualAcuityCorrection']),
                      keep_default=False)

        # Adding field 'Patient.visual_acuity_correction_both'
        db.add_column('anonymeyes_patient', 'visual_acuity_correction_both',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='patient_beo_correction', to=orm['anonymeyes.VisualAcuityCorrection']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Patient.visual_acuity_correction_right'
        db.delete_column('anonymeyes_patient', 'visual_acuity_correction_right_id')

        # Deleting field 'Patient.visual_acuity_correction_left'
        db.delete_column('anonymeyes_patient', 'visual_acuity_correction_left_id')

        # Deleting field 'Patient.visual_acuity_correction_both'
        db.delete_column('anonymeyes_patient', 'visual_acuity_correction_both_id')
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('c088a74f-5f0a-46aa-9a51-1f8903c60786')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
