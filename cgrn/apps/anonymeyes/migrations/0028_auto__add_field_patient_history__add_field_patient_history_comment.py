...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Patient.history'
        db.add_column('anonymeyes_patient', 'history',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Patient.history_comment'
        db.add_column('anonymeyes_patient', 'history_comment',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Patient.history'
        db.delete_column('anonymeyes_patient', 'history')

        # Deleting field 'Patient.history_comment'
        db.delete_column('anonymeyes_patient', 'history_comment')
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('3940ae58-5971-4f01-83c1-dd32ccfbea54')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
