...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Patient.next_reminder'
        db.alter_column('anonymeyes_patient', 'next_reminder', self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True))

        # Changing field 'Patient.postcode'
        db.alter_column('anonymeyes_patient', 'postcode', self.gf('django.db.models.fields.CharField')(max_length=6))

    def backwards(self, orm):

        # Changing field 'Patient.next_reminder'
        db.alter_column('anonymeyes_patient', 'next_reminder', self.gf('django.db.models.fields.DateField')(null=True))
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'next_reminder': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'outcome_overdue': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('c940f08c-cd95-4a6a-9a2b-2db2ffd0f790')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
