...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EthnicGroup.sort'
        db.add_column('anonymeyes_ethnicgroup', 'sort',
                      self.gf('django.db.models.fields.IntegerField')(default=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EthnicGroup.sort'
        db.delete_column('anonymeyes_ethnicgroup', 'sort')
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('8aea17a7-4f92-4701-a19c-c404ee9a3462')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
            'visual_acuity_both': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
