...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VisualAcuityReading.value'
        db.alter_column('anonymeyes_visualacuityreading', 'value', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'VisualAcuityReading.value'
        db.alter_column('anonymeyes_visualacuityreading', 'value', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=2))
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('57bda6c6-7594-4ef1-a12e-c3a50462f731')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
            'visual_acuity_both': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
