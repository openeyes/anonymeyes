...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Outcome.visual_acuity_left' to match new field type.
        db.rename_column('anonymeyes_outcome', 'visual_acuity_left', 'visual_acuity_left_id')
        # Changing field 'Outcome.visual_acuity_left'
        db.alter_column('anonymeyes_outcome', 'visual_acuity_left_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['anonymeyes.VisualAcuityReading']))
        # Adding index on 'Outcome', fields ['visual_acuity_left']
        db.create_index('anonymeyes_outcome', ['visual_acuity_left_id'])


        # Renaming column for 'Outcome.visual_acuity_both' to match new field type.
        db.rename_column('anonymeyes_outcome', 'visual_acuity_both', 'visual_acuity_both_id')
        # Changing field 'Outcome.visual_acuity_both'
        db.alter_column('anonymeyes_outcome', 'visual_acuity_both_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['anonymeyes.VisualAcuityReading']))
        # Adding index on 'Outcome', fields ['visual_acuity_both']
        db.create_index('anonymeyes_outcome', ['visual_acuity_both_id'])


        # Renaming column for 'Outcome.visual_acuity_right' to match new field type.
        db.rename_column('anonymeyes_outcome', 'visual_acuity_right', 'visual_acuity_right_id')
        # Changing field 'Outcome.visual_acuity_right'
        db.alter_column('anonymeyes_outcome', 'visual_acuity_right_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['anonymeyes.VisualAcuityReading']))
        # Adding index on 'Outcome', fields ['visual_acuity_right']
        db.create_index('anonymeyes_outcome', ['visual_acuity_right_id'])


    def backwards(self, orm):
        # Removing index on 'Outcome', fields ['visual_acuity_right']
        db.delete_index('anonymeyes_outcome', ['visual_acuity_right_id'])

        # Removing index on 'Outcome', fields ['visual_acuity_both']
        db.delete_index('anonymeyes_outcome', ['visual_acuity_both_id'])

        # Removing index on 'Outcome', fields ['visual_acuity_left']
        db.delete_index('anonymeyes_outcome', ['visual_acuity_left_id'])


        # Renaming column for 'Outcome.visual_acuity_left' to match new field type.
        db.rename_column('anonymeyes_outcome', 'visual_acuity_left_id', 'visual_acuity_left')
        # Changing field 'Outcome.visual_acuity_left'
        db.alter_column('anonymeyes_outcome', 'visual_acuity_left', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Renaming column for 'Outcome.visual_acuity_both' to match new field type.
        db.rename_column('anonymeyes_outcome', 'visual_acuity_both_id', 'visual_acuity_both')
        # Changing field 'Outcome.visual_acuity_both'
        db.alter_column('anonymeyes_outcome', 'visual_acuity_both', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Renaming column for 'Outcome.visual_acuity_right' to match new field type.
        db.rename_column('anonymeyes_outcome', 'visual_acuity_right_id', 'visual_acuity_right')
        # Changing field 'Outcome.visual_acuity_right'
        db.alter_column('anonymeyes_outcome', 'visual_acuity_right', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('e3a9e568-370c-4d39-a5a7-8bd8f240998a')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
