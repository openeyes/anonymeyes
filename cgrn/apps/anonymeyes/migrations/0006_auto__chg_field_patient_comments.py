...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Patient.comments'
        db.alter_column('anonymeyes_patient', 'comments', self.gf('django.db.models.fields.TextField')(default=''))

    def backwards(self, orm):

        # Changing field 'Patient.comments'
        db.alter_column('anonymeyes_patient', 'comments', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('a253ae47-6b3e-4572-8b0b-ac5887824598')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
