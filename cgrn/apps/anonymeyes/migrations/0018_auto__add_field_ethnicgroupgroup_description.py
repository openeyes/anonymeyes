...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EthnicGroupGroup.description'
        db.add_column('anonymeyes_ethnicgroupgroup', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EthnicGroupGroup.description'
        db.delete_column('anonymeyes_ethnicgroupgroup', 'description')
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('9dbff80c-fb96-4068-80df-1cc951dd39dc')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
