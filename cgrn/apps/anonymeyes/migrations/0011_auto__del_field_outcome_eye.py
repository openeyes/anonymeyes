...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Outcome.eye'
        db.delete_column('anonymeyes_outcome', 'eye_id')


    def backwards(self, orm):
        # Adding field 'Outcome.eye'
        db.add_column('anonymeyes_outcome', 'eye',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['anonymeyes.Eye']),
                      keep_default=False)
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('9d1c07db-e9be-4295-8b5d-b008089afdfb')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
