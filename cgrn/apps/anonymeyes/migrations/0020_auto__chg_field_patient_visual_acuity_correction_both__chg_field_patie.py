...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('anonymeyes_patient', 'visual_acuity_correction_both_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['anonymeyes.VisualAcuityCorrection']))
        ...
        db.alter_column('anonymeyes_outcome', 'visual_acuity_correction_both_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['anonymeyes.VisualAcuityCorrection']))
    ...
    models = {
        ...
        'anonymeyes.outcome': {
            ...
            'visual_acuity_both': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'outcome_beo'", 'null': 'True', 'to': "orm['anonymeyes.VisualAcuityReading']"}),
        ...
        'anonymeyes.patient': {
            ...
            'visual_acuity_both': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'patient_beo'", 'null': 'True', 'to': "orm['anonymeyes.VisualAcuityReading']"}),
