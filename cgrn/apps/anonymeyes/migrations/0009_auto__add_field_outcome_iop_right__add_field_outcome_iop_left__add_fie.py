...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Outcome.iop_right'
        db.add_column('anonymeyes_outcome', 'iop_right',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Outcome.iop_left'
        db.add_column('anonymeyes_outcome', 'iop_left',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Outcome.tonometry'
        db.add_column('anonymeyes_outcome', 'tonometry',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['anonymeyes.Tonometry']),
                      keep_default=False)

        # Adding field 'Outcome.eua'
        db.add_column('anonymeyes_outcome', 'eua',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['anonymeyes.Anaesthesia']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Outcome.iop_right'
        db.delete_column('anonymeyes_outcome', 'iop_right')

        # Deleting field 'Outcome.iop_left'
        db.delete_column('anonymeyes_outcome', 'iop_left')

        # Deleting field 'Outcome.tonometry'
        db.delete_column('anonymeyes_outcome', 'tonometry_id')

        # Deleting field 'Outcome.eua'
        db.delete_column('anonymeyes_outcome', 'eua_id')
    ...
    models = {
        ...
        'anonymeyes.patient': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('dcf0eaaf-535b-4bef-9823-db8f716ca335')", 'unique': 'True', 'max_length': '64', 'blank': 'True'}),
